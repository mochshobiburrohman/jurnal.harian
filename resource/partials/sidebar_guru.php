<aside
    ...
    >
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <li>
            <a
              href="/j_guru/resource/guru/profil.php"
          ...
          <li>
            <a
              href="/j_guru/resource/guru/index.php"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
                aria-hidden="true"
          ...
          <li>
            <a
              href="/j_guru/resource/guru/kelola_jurnal/index.php"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
                aria-hidden="true"
              ...
              <span class="ml-3">Kelola Jurnal</span>
            </a>
          </li>
        </ul>
        <ul
